...
if __name__ == "__main__":
    ...
    parser.add_argument("--particle_nb", type=int, default= 40)
    parser.add_argument("--levels", type=int, default= 40) #variable levels corresponds to the max level M
