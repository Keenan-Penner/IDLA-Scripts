...
class Eden:
    ...
    def __init__(
        ...
        """
        Args:
            birth_scale (float): exponential scale for birth. Default is 5.
            time_scale (float): exponential scale for movement. Default is 0.2.
            final_size (int): Final size of the aggregate. Default is 10000.
            ...
            save_path (str): path to save the plots. Default is "C:\\Users\\keena\\OneDrive\\Bureau\\Math\\Python\\Simulation\\sim_eden".
    ...
    def plot(self):
        ...
        plt.savefig(os.path.join(self.save_path, f"{len(self.aggregate)}.png"))
